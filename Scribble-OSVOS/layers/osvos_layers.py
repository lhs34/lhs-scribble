...
def class_balanced_cross_entropy_loss(output, label, scribble_idx, size_average=True, batch_average=True, void_pixels=None):
    ...
    # Only compute loss for frames that have scribbles
    for idx in scribble_idx:
        # TODO: Handle idx properly everywhere
